...
class Employee:
    ...
    Note: In a real Python application, you might use dataclasses or attrs
    for simpler data classes, but this adheres to the Java-like structure.
    """
    ...
    def __init__(
        ...
        # Placeholder for TrainingsTaken and badges, as they are complex objects
        self._trainings_taken: TrainingsTaken = None
