...
from python.ch6.v1.training import Training
from python.ch6.v1.enrollment import Enrollment
from python.ch6.v1.employee_not_enrolled_exception import (
    EmployeeNotEnrolledException,
)
from python.ch6.v1.offering_is_full_exception import OfferingIsFullException
...
class Offering:
    ...
    def enroll(self, employee: Employee) -> None:
    ...
    def cancel(self, employee: Employee) -> None:
    ...
    def increase_available_spots(self) -> None:
